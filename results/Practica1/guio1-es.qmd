...
if [ ! -e aln1.txt ]; then
   ...
   needle -asequence HumanChr17.fa \
          ...
          -gapopen 15.0 \
          -gapextend 0.5 \
          -outfile /mnt/c/Bioinformatica/results/2026-01-29/alng1/aln1.txt
fi
```
...
#1. Error en HumanSMARCD2 ( ponia Humana)

#2.Lee la ayuda del programa `needle` e intenta ajustar los parámetros
   para obtener un alineamiento más convincente.
   
```{bash}
if [ ! -e aln1_7.txt ]; then
   needle -asequence HumanChr17.fa \
          -bsequence HumanSMARCD2.fa \
          -gapopen 20 \
          -gapextend 0.5 \
          -outfile /mnt/c/Bioinformatica/results/2026-01-29/alng1/aln1_7.txt
...
if [ ! -e aln2.txt ]; then
   ...
   water -asequence /mnt/c/Bioinformatica/results/2026-01-29/HumanChr17.fa \
         -bsequence HumanSMARCD2.fa \
         -gapopen 10 \
         -gapextend 0.5 \
         -outfile /mnt/c/Bioinformatica/results/2026-01-29/alng2/aln2.txt
...
if [ ! -e aln2.afa ]; then
   ...
   water -asequence HumanChr17.fa \
         ...
         -gapopen 10 \
         -gapextend 0.5 \
         -outfile /mnt/c/Bioinformatica/results/2026-01-29/alng2/aln2.afa \
         -aformat3 pair 
...
if [ ! -e alngchimp1 ]; then
   ...
   if [ ! -e ChimpChr17 ]; then
     wget -O ChimpChr17 \
     "https://rest.ensembl.org/sequence/region/chimpanzee/17:63309800..63321000:1?content-type=text/x-fasta"
   fi
  
needle -asequence ChimpSMARCD2 \
       -bsequence ChimpChr17 \
       -gapopen 10 \
       -gapextend 0.5 \
       -outfile /mnt/c/Bioinformatica/results/2026-01-29/alng3/alngchimp1 \
      
fi
       
if [ ! -e alngchimp2 ]; then 

water -asequence ChimpSMARCD2 \
      -bsequence ChimpChr17 \
      -gapopen 10 \
      -gapextend 0.5 \
      -outfile /mnt/c/Bioinformatica/results/2026-01-29/alng3/alngchimp2 \
...
library('htmltools')
library('DECIPHER')
PF00009 <- readAAStringSet("C:/Bioinformatica/results/2026-01-29/muscle/PF00009.afa")
